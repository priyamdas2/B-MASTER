...
SubsetNum <- 2   # 1 = Most abundant, 2 = Differential in cancer
...
MasterRanks.set <- as.matrix(read.table(paste0('Output/MasterRanks_subset', SubsetNum,'.csv'), header = FALSE, sep = ",")) 
...
plot
ggsave(paste0('Output/CumCCA_subset',SubsetNum,'.jpeg'), plot = plot, width = 6, height = 4.5, dpi = 400)
