...
2. Run `2_Data_analysis.R`, `3_Extra_plots.R`, `4_Extra_supp_plots.R`, `5_patient_summary_plots.R`, `6_Scores_plot.R` in this respective order to perform exploratry analysis and generate exploratory plots.
