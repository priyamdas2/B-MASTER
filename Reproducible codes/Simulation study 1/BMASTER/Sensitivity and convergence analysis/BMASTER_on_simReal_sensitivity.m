...
delta_1 = 0.01;        % rate lambda1square (prior)
...
parfor rep = 1:NumExp
    ...
    filename = ['Output/Sensitivity_delta1_',num2str(delta_1),'_delta2_',num2str(delta_2),'_NonZeroLocation_BMASTER_rep_',num2str(rep),'.csv'];
    csvwrite(filename,IndicatorNonzero_est)
    filename = ['Output/Sensitivity_delta1_',num2str(delta_1),'_delta2_',num2str(delta_2),'_TPR_FPR_MCC_AUC_AUC20_sparsity_BMASTER_rep_',num2str(rep),'.csv'];
    csvwrite(filename,TPR_FPR_MCC_AUC_AUC20_sparsity)
    filename = ['Output/Sensitivity_delta1_',num2str(delta_1),'_delta2_',num2str(delta_2),'_AUC_curve_BMASTER_rep_',num2str(rep),'.csv'];
    csvwrite(filename,Final_FPR_TPR)
    filename = ['Output/Sensitivity_delta1_',num2str(delta_1),'_delta2_',num2str(delta_2),'_MasterRanks_rep_',num2str(rep),'.csv'];
    csvwrite(filename,MasterRanks)
    filename = ['Output/Sensitivity_delta1_',num2str(delta_1),'_delta2_',num2str(delta_2),'_compTime_rep_',num2str(rep),'.csv'];
